...
class LinkedBST(AbstractCollection):
    ...
    def __str__(self):
        ...
        def recurse(node, level):
            represent_s = ""
            if node != None:
                represent_s += recurse(node.right, level + 1)
                represent_s += "| " * level
                represent_s += str(node.data) + "\n"
                represent_s += recurse(node.left, level + 1)
            return represent_s
    ...
    def height(self):
        ...
        def height1(top):
            ...
            if top.left is None and top.right is None:
                return 0
            left_sum = height1(top.left) if top.left is not None else 0
            right_sum = height1(top.right) if top.right is not None else 0
    ...
    def range_find(self, low, high):
        ...
        :return:
        '''
        return [item for item in list(self.inorder()) if item >= low and item <= high]
    ...
    def successor(self, item):
        ...
        """
        try:
            return [element for element in self.inorder() if element > item][0]
        except IndexError:
            return None
    ...
    def predecessor(self, item):
        ...
        """
        try:
            return [element for element in self.inorder() if element < item][-1]
        except IndexError:
            return None
